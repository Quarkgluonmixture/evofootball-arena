...
const ZH: Record<string, string> = {
  ...
  'Tac feed': '战术流',
  Lighting: '光线',
  // A4 play-test worlds (#156 / #167.5) — the labels the badge names on screen.
  'A4 world v1 · 统一约定 (play-test)': 'A4 约定世界 v1 · 统一约定(试玩)',
  'A4 world v2 · 纪律 (play-test)': 'A4 约定世界 v2 · 纪律(试玩)',
  ...
  '  ↳ …and price passes by measured shot value': '  ↳ …并按实测的射门价值给传球定价',
  'On top of the above: the passer prices every option by how often that pass has actually LED TO A SHOT, instead of by how likely it is to arrive. Measured: a more DIRECT game — more forward passes than the legacy brain, shots +22%, goals unchanged — but markedly fewer slow-developing wide patterns (an overlap release roughly halves). The question only you can answer is whether the direct game is better football.':
    '在上面那一项之上:传球者给每个选项定价,用的是「这一脚实际有多常导向射门」,而不是「它有多大概率传到」。实测:更直接的比赛——前向传球比旧脑还多、射门 +22%、进球不变——但慢慢发育的边路配合明显变少(套边释放大约减半)。只有你能回答的问题是:更直接的比赛是不是更好的足球。',
  Day: '白天',
  Night: '夜场',
  ...
  // ---- the player center (Phase 56) ----
  Players: '球员',
  'Player center': '球员中心',
  'Player style space': '球员风格空间',
  'Every player in the league, plotted where the population disagrees most — attributes and personal appetites together.':
    '全联盟球员，落在种群分歧最大的两个维度上——属性与个人偏好同场较量。',
  All: '全部',
  'Player deep dive': '球员深潜',
  'no distinction earned yet': '还没有挣得任何标签',
  'seasons#': '个赛季',
  'saves#': '扑救',
  'best rating': '最佳评分',
  'personal appetites (vs the coach\'s ×1.0)': '个人偏好(相对教练基准 ×1.0)',
  'Transfers & the market': '转会与市场',
  'Free agents — careers waiting for a club': '自由球员——等待下家的生涯',
  'The market is empty — it fills when a club folds.': '市场空空如也——有俱乐部倒闭时才会有人入市。',
  ability: '能力',
  'ex-': '前',
  'Signings — careers that survived their clubs': '签约史——在俱乐部倒闭后延续的生涯',
  'from the ashes of': '来自灰烬中的',
  'Population census': '群像普查',
  'players with an earned nameplate': '拥有个人铭牌的球员',
  'Active career scorers': '现役生涯射手榜',
  'career goals': '生涯进球',
  clinical: '冷血射手',
  playmaker: '组织大师',
  enforcer: '铁闸',
