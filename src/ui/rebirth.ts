...
export function geneAxisLabels(lang: 'zh' | 'en'): string[] {
  const ZH: Record<GeneKey, string> = {
    ...
    rotationBias: '轮换', underdogShift: '逆境', tinkerBias: '临场', fitBias: '引援', jockeyBias: '延缓',
  };
  const EN: Record<GeneKey, string> = {
    ...
    rotationBias: 'rota', underdogShift: 'udog', tinkerBias: 'tink', fitBias: 'fit', jockeyBias: 'jock',
  };
