# PROGRAMME — Commander rulings ARCHIVE 2 (#285–#302, verbatim frozen bytes)

> Rotated out of the live file on 2026-08-19 (ruling #306; the #303 item 2 process law —
> the closed BU→PW→PC era). BYTE-VERBATIM below, cmp-verified at rotation. Never reword.
> Find any ruling: `grep -n "RULING #N " docs/world-model/PROGRAMME-RULINGS*.md`.
