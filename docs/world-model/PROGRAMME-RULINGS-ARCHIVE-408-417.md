# PROGRAMME — Commander rulings ARCHIVE #408–#417 (byte-verbatim; rotated 2026-09-19 at ruling #418)

> Rotated out of the live `PROGRAMME-RULINGS.md` per the ~1,500-line rule (#303 item 2). Nothing reworded. Era: DS-T0b → DS-T1b/T0c/T1c → world 16 → DS-T0d/T1d → world 17 → IF-C0 → the IF fork resolved 甲 by the user → the IF contract bound.
