# PROGRAMME — Commander rulings ARCHIVE, #373–#381 (byte-verbatim)

> Rotated out of the live file by ruling **#382** item 8 (2026-09-05; the #303 rotation law).
> Rulings **#373–#381 verbatim** — nothing reworded (RC-C0b banked → the BF arc: BF-C0 · BF-T0 +
> its clamp-order fix · BF-T1 → RC-T0b + its trade-form fix → RC-T1b = FAIL on the user's third
> sentence → BN-C0 the bounce census). The live file
> [`PROGRAMME-RULINGS.md`](PROGRAMME-RULINGS.md) holds #382 onward; earlier eras:
