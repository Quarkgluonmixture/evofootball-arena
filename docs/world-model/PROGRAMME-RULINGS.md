# PROGRAMME — Commander rulings (verbatim; LIVE FILE, #285 onward)

> This file holds commander rulings **#285 onward, verbatim**, APPENDED in numeric
> order — nothing is ever reworded. Rulings #2–#284 live byte-verbatim in
> [`PROGRAMME-RULINGS-ARCHIVE-001-284.md`](PROGRAMME-RULINGS-ARCHIVE-001-284.md)
> (rotated 2026-08-19, ruling #303; the unnumbered 2026-07-24 ruling remains in
> `PROGRAMME.md`'s context block). **Resume = `tail -n 120` of THIS file.** To find
> any ruling by number: `grep -n "RULING #N " docs/world-model/PROGRAMME-RULINGS*.md`.
> Rotation rule: when this live file outgrows comfortable single-read size (~1,500
> lines), the closed era rotates to a new ARCHIVE file in the same round as a ruling,
> byte-verbatim, cmp-verified, recorded in that ruling.
