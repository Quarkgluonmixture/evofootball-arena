# PROGRAMME — ARCHIVE 1 (frozen history sections, byte-verbatim)

> Rotated out of [`PROGRAMME.md`](PROGRAMME.md) on 2026-08-19 (the readability rotation,
> ruling #303). Two verbatim chunks: (1) the 2026-07-24 context/direction/rulings-index/
> track tables/self-drive sections; (2) the "Sequence at a glance" sketch. PROGRAMME.md
> keeps only: the ⭐QUEUE, the §0.0 operations protocol, and Governance (live law).
> Nothing here is reworded. Grep this file for any past detail.
...
> (chunk 2 — the closing sketch, verbatim:)
