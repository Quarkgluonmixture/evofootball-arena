...
**Queue state (2026-07-25, after ruling #8): E2a-2 is the next step — the
executor drafts the OPTION-SPACE census contract under Autonomous mode; on
its PASS, E2b proceeds without a new ruling.** E2a-1's split verdict is
