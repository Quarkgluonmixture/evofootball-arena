...
**Queue state (2026-07-27, ruling #26 in progress): C5 PHASE-0 CODE MAP DONE
...
**Next in the executor queue per #26.4: the C4 Phase-0 code map** (header /
cross / box-arrival resolution). **F9 remains available at any time**
