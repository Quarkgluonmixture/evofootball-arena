...
**Queue state (2026-07-27, #32 executed): ⏸ C4 T2-ARRIVAL is PRE-REGISTERED
and NOT RUN** → [`C4-T2-ARRIVAL.md`](C4-T2-ARRIVAL.md). #32.1's
coupon-collector ban is codified in PROBE-CONTRACTS §2 (`3c61d68`). Nothing
is in flight; the stage runs on the commander's word.

⭐⭐ **The pre-registration turned up two code findings that change the
mechanism, and both are surfaced for reversal before the run:**
