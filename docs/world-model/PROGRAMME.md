...
**Queue state (2026-07-26): E5 RUN — E5a PASS on every gate, E5b 30/32 with the
CENTRAL HYPOTHESIS FAILED. Per ruling #15 (c) the queue STOPS AT THE COMMANDER.
E4 round 2 does not open, every flag stays default OFF, and nothing was
repaired after the result: the finding is that a one-step measured value buys a
more direct game (shots +17.5%, overlaps and give-and-gos recovered, the §2 band
healthier than E3R's) but does NOT reproduce third-man combination play — it
makes it worse. Open questions for the commander in `EDS-E5-VALUE-AXIS.md`
§7.2: whether the myopia diagnosis or E5a's under-sampled attacking-third cells
carries the failure, and whether seat 2 (the gaze consumer) or a two-step value
comes next.**
