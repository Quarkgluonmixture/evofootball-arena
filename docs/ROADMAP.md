...
## 🎨 F-Q render quality + contact cues SHIPPED 2026-09-15 (user report 「很糊而且不真实碰撞」) — render-only, fingerprint untouched; the four blur sources, the bump cue and what was deliberately NOT done are in F-DIRECTION § *Render quality*; the user judges on the live phone
...
> ✅ **O0 OFF-BALL OFFER FIELD REPRESENTATION COMPLETE (2026-07-21, byte-identical):**
> role-neutral hold + symmetric numbered direction/time samples now feed an unscored vector
> of self/opponent arrival, teammate occupancy, carrier-corridor clearance, pitch/offside and
> observation facts. Fixed-world-point evaluation makes pace/acceleration counterfactuals
> honest. Seven focused tests, all 537 tests, TypeScript/build and the frozen fingerprint pass;
...
> ✅ **2026-07-22 D-PROC-0T PRIVATE-INTENT PROTOCOL PASSED.** The user selected
...
> D-PROC-0T separates private transaction, embodied evidence and observer-owned
> candidate evidence in a probe-only privacy/observability gate. Frozen 84k result:
> 96/96 accepted; 80 jointly completed; H/X private targets differed while physical,
> evidence and hypothesis histories were identical in 96/96; E produced >=0.25m
> extra target progress in 69/80; candidate-dependent and observer-specific evidence
> in 80/80; true-target evidence improved in 47/80; revocation leaked before body
> change 0 times and changed evidence after embodiment in 80/80. Zero schema/RNG/
